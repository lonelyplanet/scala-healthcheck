...
object HealthCheckEntity {
  ...
  private def relationships(serviceDependencies: Seq[ServiceDependency])
    : Option[Map[String, Relationship]] = {
    for {
